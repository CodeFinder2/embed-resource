...
inline bool exists(const char *file) { return ifstream(file).good(); }
...
int main(int argc, char *argv[])
{
  ...
  while (ifs >> noskipws >> c) {
    ofs << "char(0x" << hex << (c & 0xff) << (i++ < int(file_size) - 1 ? "), " : ") ");
    if (++line_break == 10) {
      ofs << "\n  ";
      line_break = 0;
    }
  ...
  if (!header_exists) {
    ofs_header << "// WARNING: this file is auto-generated by CMake" CMAKE_VERSION "! Do not edit!\n"
